$(function() {
  ...
  var certType = ''
    ...
    if (window.sessionStorage.getItem("uuid")) {
                    ...
                    success: function(res) {
                      ...
                      if (res.errMsg == "chooseWXPay:ok") {
                        ...
                        $.ajax({
                          ...
                          success:function(){
                            window.location.href('http://aj.kingwingaviation.com/retailsys/short1.html')
                          }
                        });
                      }
                    ...
                    cancel: function() {
                      ...
                      $.ajax({
                        ...
                        success:function(){
                         ...
                         "http://aj.kingwingaviation.com/retailsys/short1.html"
                       );
                        }
                      });
                    }
      ...
      window.location.href =
        "http://aj.kingwingaviation.com/jax/retailsys/pay/code?state=http://aj.kingwingaviation.com/retailsys/short1.html";
    }
    ...
    var dataShare = {
      ...
      link: 'http://aj.kingwingaviation.com/retailsys/short1-main.html',   
